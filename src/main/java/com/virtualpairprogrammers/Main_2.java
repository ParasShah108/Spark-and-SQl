...
//			
		JavaRDD<String> reviewRddfile = sc.textFile("C:\\Users\\Paras_Shah\\Desktop\\Java Training\\reviews.txt");
//				
...
////		
		JavaRDD<String> removedSpecialCharRdd = noblankreviews.map(sentance -> sentance.replaceAll("[^a-zA-Z]+", "_"));
//				
...
////		
          JavaRDD<String>  noNumericReviews = removedSpecialCharRdd.filter(sentence -> sentence.matches("[^0-9]*$"));
////         
